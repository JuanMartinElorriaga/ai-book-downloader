...
@click.command()
@click.option('--author', prompt='select author', default=False, help='Author to search in Library Genesis and download all books in the database', type=str)
@click.option('--directory_path', prompt='select destination folder', default="./downloads/", help='Directory path to save all the books found', type=str)
